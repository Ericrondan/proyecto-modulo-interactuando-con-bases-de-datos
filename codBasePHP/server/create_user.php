<?php
    ...
    CrearUsuarios("Pablo Gonzales","1993/07/16","Pablo@email.com","12345");
    CrearUsuarios("Maria Rodriguez","1992/01/16","Maria@email.com","123456");
    CrearUsuarios("Roberto Gomez","1990/01/16","Robert@email.com","1234567");
    ...
    if($Resultado==0){
        ...
        VALUES ('".$Nombre."', '".$FechaNacimiento."', '".$UserName."', '".password_hash($Password, PASSWORD_DEFAULT)."')";
